...
public class UsuarioService {
    ...
    private final PublishSubject<Usuario> emitCreateUser = PublishSubject.create();
    ...
    public UsuarioService(UsuarioRepository usuarioRepository) {
        ...
        this.getEmitCreateUser().subscribe(usuario -> {
    ...
    public UsuarioDTO save(UsuarioDTO usuarioDTO) {
        ...
        this.setEmitCreateUser(usuario);
        return toDTO(usuario);
    }
    ...
    public PublishSubject<Usuario> getEmitCreateUser() {
        return emitCreateUser;
    }

    public void setEmitCreateUser(Usuario usuario) {
        emitCreateUser.onNext(usuario);
    }
}